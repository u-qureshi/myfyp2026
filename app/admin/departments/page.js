  ...
  return (
    ...
    >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <Card className={`bg-white ${adminTheme.statBorder}`}>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-medium text-gray-600">Total Departments</CardTitle>
              </CardHeader>
              <CardContent>
                <div className={adminTheme.statValue}>{stats.departments}</div>
              </CardContent>
            </Card>

            <Card className={`bg-white ${adminTheme.accentStatBorder}`}>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-medium text-gray-600">Total Programs</CardTitle>
              </CardHeader>
              <CardContent>
                <div className={adminTheme.accentStatValue}>{stats.programs}</div>
              </CardContent>
            </Card>

            <Card className={`bg-white border-l-4 border-l-[#002d6b]`}>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-medium text-gray-600">Total Sections</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-serif font-bold text-[#002d6b]">{stats.sections}</div>
              </CardContent>
            </Card>
          </div>
